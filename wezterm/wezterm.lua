...
return {
    default_prog = { 'ssh', '-Y', 'djlie98@192.168.1.84' },
	...
	background = {
		...
		{
			source = { File = { path = 'C:\\Users\\jerem\\Data\\Media\\assets\\rose_thorn.png' } },
			height = "Cover",
			width = "Cover",
		...
		},
		{
			source = {
				File = {
					path = 'C:\\Users\\jerem\\Data\\Media\\assets\\blob_blue.gif',
					speed = 1,
				},
			},
				repeat_x = "NoRepeat",
